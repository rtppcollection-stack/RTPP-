...
export const SUPPORTED_DEXES: DEXOption[] = [
  {
    id: "uniswap",
    name: "RTPP Universal EVM Pool",
    chain: "Base / Ethereum / Arbitrum",
    logo: "⚡",
    logoUrl: "",
    color: "from-amber-500/20 to-primary/20 border-amber-500/40",
    volume24h: "$1.45B",
    avgFee: "0.05% - 0.30%",
    status: "Optimal",
    description: "RTPP Universal concentrated liquidity smart contract router.",
    officialUrl: "#",
  },
  {
    id: "aerodrome",
    name: "RTPP Base Liquidity Hub",
    chain: "Base Network (EVM)",
    logo: "🔵",
    logoUrl: "",
    color: "from-blue-600/20 to-cyan-500/20 border-blue-500/40",
    volume24h: "$450M",
    avgFee: "0.05% - 0.30%",
    status: "Optimal",
    description: "Central liquidity hub on Base Network with automated admin fee routing.",
    officialUrl: "#",
  },
  {
    id: "pancakeswap",
    name: "RTPP BSC High-Speed Pool",
    chain: "BNB Chain / Base / EVM",
    logo: "🟡",
    logoUrl: "",
    ...
    avgFee: "0.01% - 0.25%",
    status: "Active",
    description: "RTPP optimal liquidity router interface on BNB & EVM chains.",
    officialUrl: "#",
  },
  {
    id: "raydium",
    name: "RTPP Solana Liquidity Engine",
    ...
    avgFee: "0.25%",
    status: "Optimal",
    description: "RTPP ultra-fast AMM liquidity routing on Solana.",
    officialUrl: "#",
  },
  {
    id: "sushiswap",
    name: "RTPP Multi-Chain Router",
    ...
    avgFee: "0.30%",
    status: "Active",
    description: "Universal cross-chain liquidity aggregator.",
    officialUrl: "#",
  },
  {
    id: "traderjoe",
    name: "RTPP Avalanche Liquidity Book",
    ...
    avgFee: "0.15% - 0.20%",
    status: "Active",
    description: "RTPP zero-slippage liquidity book architecture.",
    officialUrl: "#",
  },
  {
    id: "orca",
    name: "RTPP Solana Deep Pool",
    chain: "Solana Network",
    logo: "💎",
    logoUrl: "",
    ...
    avgFee: "0.07%",
    status: "Optimal",
    description: "RTPP concentrated liquidity protocol on Solana.",
    officialUrl: "#",
  },
];
  ...
  if (dex.logoUrl && !hasError) {
    return (
      <img
        ...
        className={`${className} rounded-full object-contain shrink-0 bg-background/80 ring-1 ring-border/50 p-0.5`}
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 p-3 rounded-xl bg-surface-2/80 border border-border">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <DexLogoImage dex={activeDex} className="h-4 w-4" />
          ...
          >
            ...
            {SUPPORTED_DEXES.map((dex) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <DexLogoImage dex={dex} className="h-5 w-5" />
                  <div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2 mb-2">
                <div className="flex items-center gap-2">
                  <div
                    className={`h-9 w-9 rounded-xl flex items-center justify-center shadow-sm border overflow-hidden shrink-0 ${
                      isSelected ? "bg-surface border-primary/50" : "bg-surface-2 border-border"
                    }`}
                  >
                    <DexLogoImage dex={dex} className="h-6 w-6" />
                  </div>
                  <div>
